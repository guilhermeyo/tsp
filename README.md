...
**Keep holding and it pins.** A ring fills around a padlock under your finger, and after 1.2 seconds
the cover is yours: no countdown left, nothing leaves on its own. The padlock settles at the top to
say so. From there, tap or drag sideways to carry on to the app you picked, or take the button at the
bottom to stay here instead.

The ring is also the honest answer to whether the touch was seen at all. If none appears, the press
landed in the dead window described below: lift, press again.
